...
```{r write}
print(paste0(params$out_dir, '/gene_expression/', params$project, '_non_zero_counts_matrix.RData', sep=''))
print(paste0(params$out_dir, '/gene_expression/', params$project, '_norm_counts_matrix.RData', sep=''))
save(cm, file = paste0(params$out_dir, '/', params$project, '_non_zero_counts_matrix.RData', sep=''))
save(ncm, file = paste0(params$out_dir, '/', params$project, '_norm_counts_matrix.RData', sep=''))
```
